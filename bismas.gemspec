...
Gem::Specification.new do |s|
  ...
  s.files = ["COPYING", "ChangeLog", "README", "Rakefile", "bin/bismas", "lib/bismas.rb", "lib/bismas/base.rb", "lib/bismas/cli.rb", "lib/bismas/mapping.rb", "lib/bismas/parser.rb", "lib/bismas/reader.rb", "lib/bismas/version.rb", "lib/bismas/writer.rb", "spec/bismas/parser_spec.rb", "spec/bismas/reader_spec.rb", "spec/data/test.dat", "spec/spec_helper.rb"]
  s.homepage = "http://github.com/blackwinter/bismas"
  s.licenses = ["AGPL-3.0"]
  s.post_install_message = "\nbismas-0.1.0 [2015-11-20]:\n\n* First release.\n\n"
  s.rdoc_options = ["--title", "bismas Application documentation (v0.1.0)", "--charset", "UTF-8", "--line-numbers", "--all", "--main", "README"]
